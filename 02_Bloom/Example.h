...
public:
	Example(HWND window, int width, int height)
	{
		...
		*/
		...
		{
			image.pixels[i].v[0] = std::clamp(image.pixels[i].v[0] * brightness, 0.0f, 1.0f);
			image.pixels[i].v[1] = std::clamp(image.pixels[i].v[1] * brightness, 0.0f, 1.0f);
			image.pixels[i].v[2] = std::clamp(image.pixels[i].v[2] * brightness, 0.0f, 1.0f);
		}*/
		...
		image.Bloom(0.3f, 10, 1.0f);// image_1
	...
	void Update()
	{
		...
		*/
		...
		//		/*image.pixels[i * image.width + j].v[0] = image.pixels[i * image.width + j].v[0] == 0.0f ? 0.01f : image.pixels[i * image.width + j].v[0];
		//		image.pixels[i * image.width + j].v[1] = image.pixels[i * image.width + j].v[1] == 0.0f ? 0.01f : image.pixels[i * image.width + j].v[1];
		//		image.pixels[i * image.width + j].v[2] = image.pixels[i * image.width + j].v[2] == 0.0f ? 0.01f : image.pixels[i * image.width + j].v[2];*/

		//		/*if (j > image.width / 2) {
		//			image.pixels[i * image.width + j].v[0] = std::clamp(image.pixels[i * image.width + j].v[0] * brightness, 0.0f, 1.0f);
		//			image.pixels[i * image.width + j].v[1] = std::clamp(image.pixels[i * image.width + j].v[1] * brightness, 0.0f, 1.0f);
		//			image.pixels[i * image.width + j].v[2] = std::clamp(image.pixels[i * image.width + j].v[2] * brightness, 0.0f, 1.0f);
		//		}
		//		else {
		//			image.pixels[i * image.width + j].v[0] = std::clamp(image.pixels[i * image.width + j].v[0] * (maxBrightness - brightness), 0.0f, 1.0f);
		//			image.pixels[i * image.width + j].v[1] = std::clamp(image.pixels[i * image.width + j].v[1] * (maxBrightness - brightness), 0.0f, 1.0f);
		//			image.pixels[i * image.width + j].v[2] = std::clamp(image.pixels[i * image.width + j].v[2] * (maxBrightness - brightness), 0.0f, 1.0f);
		//		}*/

...
namespace hlab
{
	...
	public:
		...
		vec3 traceRay2x2(vec3 eyePos, vec3 pixelPos, const float dx, const int recursiveLevel)
		{
			...
			pixelColor += traceRay2x2(eyePos, pixelPos + glm::vec3(subdx, 0, 0), subdx, recursiveLevel - 1);
			pixelColor += traceRay2x2(eyePos, pixelPos + glm::vec3(0, subdx, 0), subdx, recursiveLevel - 1);
			pixelColor += traceRay2x2(eyePos, pixelPos + glm::vec3(subdx, subdx, 0), subdx, recursiveLevel - 1);

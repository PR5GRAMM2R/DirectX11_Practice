...
int main()
{
	...
	while (WM_QUIT != msg.message)
	{
		...
		else
		{
			...
			ImGui::SliderFloat3("Light Pos", &example->raytracer.light->pos.x, -10.0f, 10.0f);
			ImGui::SliderFloat3("Eye Pos", &example->raytracer.eye->pos.x, -10.0f, 10.0f);
			//ImGui::SliderFloat("RGB", &example->raytracer.light.pos.z, 0.0f, 1.0f);
